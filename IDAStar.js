function IDAStar(startRowIndex,
    startColIndex,
    endRowIndex,
    endColIndex,
    allowDiagonal) {
    ...
    function performIDAStar(
        ...
        depth = startRowIndex - endRowIndex;
        ...
        while (st.length > 0) {
            ...
            for (let i = 0; i < rowNbr.length; i++) {
                ...
                if (isValid(r, c) && isValidIDA(r, startRowIndex, endRowIndex, isObstacle, depth)) {
            ...
            for (let j = 0; j < rowNbr.length; j++) {
                ...
                if (isValid(r, c) && isValidIDA(r, startRowIndex, endRowIndex, isObstacle, depth) && !st.includes(r + ',' + c)) {
    ...
    function isValidIDA(row, startRowIndex, endRowIndex, isObstacle, depth) {
        if (isObstacle) {
            if (depth >= 0 && (row > startRowIndex || row < endRowIndex - depth)) {
                return false;
            }
            else if (depth < 0 && (row < startRowIndex || row > endRowIndex + Math.abs(depth))) {
                return false;
            }
        }
        else {
            if (depth >= 0 && (row > startRowIndex || row < endRowIndex)) {
                return false;
            }
            else if (depth < 0 && (row < startRowIndex || row > endRowIndex)) {
                return false;
            }
        }
        return true;
